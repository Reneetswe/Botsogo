      ...
      <div className="screen active" id="screen-landing">
        <div className="hero">
          ...
          <div className="hero-inner">
            ...
            <div className="hero-actions">
              <Link className="btn-hero" href="/patient/register">Register now</Link>
              <Link className="btn-hero-out" href="/patient/login">I already have an account</Link>
            </div>
          </div>
        </div>
        <div className="strip">
        ...
        <div className="section" id="features">
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <div className="section-sub">Four interconnected features that cover your full journey from home to discharge.</div>
          </div>
          <div className="grid-3">
            <div className="feat-card"><div className="feat-img"><i className="ti ti-home-check"></i></div><div className="feat-body"><div className="feat-label">Feature 1</div><div className="feat-title">Pre-Arrival Check-In</div><p className="feat-p">Check into the queue before you leave home via the app or USSD *384# on any phone. Get a queue number and an estimated arrival slot so you are not sitting at the clinic from 6 AM.</p></div></div>
            ...
            <div className="feat-card"><div className="feat-img"><i className="ti ti-pill"></i></div><div className="feat-body"><div className="feat-label">Feature 4</div><div className="feat-title">Medicine Availability</div><p className="feat-p">Log in to check which clinics have your medicine in stock before leaving home. Updated in real time by clinic staff.</p></div></div>
          </div>
        </div>
        ...
        <div className="stats-row">
          ...
          <div className="stat-item"><i className="ti ti-device-mobile"></i><div className="stat-num">*384#</div><div className="stat-lbl">USSD — any phone</div></div>
        </div>
        <Footer />
      </div>
    </>
